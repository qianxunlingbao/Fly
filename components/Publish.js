...
export default class Publish extends Component {
	...
	constructor(props){
		...
		clicknum3:0,
		iscollect:true,
		whoosh : new Sound(`${this.props.data.music_value}`,null, (e) => {
                if (e) {
                     console.log('播放失败');
                    return;
                }
		...
		<Text  style={{color:'#fff',fontSize:30,paddingBottom:'2%'}}>{this.props.data.music_name}</Text>
					<Text  style={{color:'#ccc',paddingBottom:'2%'}}>{this.props.data.music_author}</Text>
					<Text  style={{color:'#ccc'}}>歌曲类型</Text>
					</View>

					<TouchableOpacity   style={{flex:1,marginLeft:'7%',marginTop:'2%'}} onPress={this.clickheart}>
					<Image style={{width:'46%',height:'20%'}} source={this.state.iscollect?require('../images/heart.png' ):require('../images/heart.png')} />
					</TouchableOpacity>
				</View>
	...
	<View style={{flex:5,flexDirection:'row',paddingBottom:'1%',justifyContent:'center',marginLeft:'9%',alignItems: 'center'}}>
		...
		<TouchableOpacity   >
		<Image style={{width:'35%',height:'70%',marginTop:'15%'}} source={require('../images/back.png' )} />
		</TouchableOpacity>
		</View>
		<View style={{flex:2,justifyContent:'center'}}>
		<TouchableOpacity  onPress={this.onPressclick} >
		<Image style={{width:'46%',height:'100%',marginLeft:'10%'}} source={this.state.clicknum1%2?require('../images/suspend.png' ):require('../images/broadcast.png')} />
		</TouchableOpacity>
		</View>
		<View style={{flex:1,justifyContent:'center'}}>
		<TouchableOpacity    >
		<Image style={{width:'35%',height:'70%',marginTop:'15%',marginLeft:'-10%'}} source={require('../images/next.png' )} />
		</TouchableOpacity>
		</View>
		<View style={{flex:1,justifyContent:'center'}}>
		<TouchableOpacity  >
		<Image style={{width:'35%',height:'70%',marginTop:'15%'}} source={require('../images/list.png' )} />
		</TouchableOpacity>
		</View>
		</View>
		</View>
