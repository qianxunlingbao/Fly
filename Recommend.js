      ...
      render() {
          return (
              <View>
                                ...
                                <TouchableOpacity style={{justifyContent:'center', alignItems: 'center',marginTop:height*0.05}} onPress={() => { this.setModalVisible4(true) }}>
                                ...
                                width:'100%',
                                    ...
                                    style = {{
                                        width:'100%',
                                            ...
                                            <TouchableOpacity style={{marginLeft:0.3*width}} onPress={() => { this.setModalVisible4(false) }}>
                                    ...
                                    style = {{
                                        width:'100%',
                                            ...
                                            ,flexDirection:'row',
                                                ...
                                                <TouchableOpacity onPress={() => { this.setModalVisible6(true) }}>
                                                    <View  style={{width:0.3*width,marginLeft:0.2*width,flexDirection:'row',borderWidth: 1,height:0.05*height, justifyContent:'center', alignItems: 'center',
                                                                    borderTopLeftRadius: 0.15*width,
                                                                    borderTopRightRadius:  0.15*width,
                                                                    borderBottomRightRadius:  0.15*width,
                                                                    borderBottomLeftRadius:  0.15*width,
                                                    ...
                                                    <Image style={{width:0.05*width,height:0.05*width}} source={require('../images/vIDEO.png')}/>
                                                    <Text style={{ marginLeft:0.01*width,fontSize:18,color:"#b3ffb4"}}>歌词视频</Text>
                                                    </View>
                                                </TouchableOpacity>
                                        </View>
                            </View>
